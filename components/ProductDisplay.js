app.component("product-display", {
    ...
    <div class="product-container">
      ...
      <div class="product-info">
        ...
        <button 
          ...
          :class="{ disabledButton: !inStock}" 
          :disabled="!inStock"
          @click="deleteToCart">Delete to Cart
        </button>
      </div>
    </div>
  ...
  methods: {
    ...
    deleteToCart() {
        ...
        if (this.variants[this.selectedVariant].id == 0) {
            this.inStock = true
        }
    },
    addReview(review) {
  ...
  computed: {
    title() {
      return this.brand + " " + this.producto;
    },
    image() {
      return this.variants[this.selectedVariant].image;
    },
    inStock() {
      return this.variants[this.selectedVariant].quantify;
    },
    shipping(){
        if(this.premium) {
            return 'Free'
